...
# export PYTHONPATH=C:\Users\KARUNYA MURALEE\AppData\Local\Packages\PythonSoftwareFoundation.Python.3.9_qbz5n2kfra8p0\LocalCache\local-packages\Python39\site-packages
...
class Ui_MainWindow(object):
        def setupUi(self, MainWindow):
                ...
                self.verticalSlider_3.valueChanged['int'].connect(self.sharpen_value)
                ...
                self.sharpen_value_now = 0 # Updated sharpness value
        ...
        def update(self):
                ...
                img = self.changeSharpness(img, self.sharpen_value_now)
